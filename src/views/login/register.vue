<template>
  <div class="register">
    <el-dialog :visible.sync="dialogVisible" width="600px" center>
      ...
      <el-form label-width="100px" :model="resgisterForm" ref="registerFormRef" :rules="rules">
        ...
        <el-form-item label="图形码" prop="code">
          <el-row>
            ...
            <el-col :span="6" style="margin-left:10px">
              <img class="captcha" :src="codeURL" alt @click="changeCodeURL" />
            </el-col>
          </el-row>
        </el-form-item>
